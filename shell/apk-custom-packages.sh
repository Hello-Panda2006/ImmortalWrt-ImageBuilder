...
CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-theme-aurora luci-app-aurora-config luci-i18n-aurora-config-zh-cn -luci-theme-argon -luci-app-argon-config -luci-i18n-argon-config-zh-cn"
# 分区扩容 by sirpdboy 
